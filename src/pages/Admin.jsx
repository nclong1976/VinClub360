...
import StocksCasinoTab from "@/components/admin/StocksCasinoTab";
import NewsTab from "@/components/admin/NewsTab";
import SettingsTab from "@/components/admin/SettingsTab";

// "Hợp đồng" đã gộp vào subtab thứ 4 của "Quản lý Hội viên & Giao dịch" (MemberHubTab).
// "Đầu tư chứng khoán" và "Quản lý Casino" được gộp chung vào 1 phân hệ điều hành tiện lợi.
const TABS = [
  { id: "member_hub", label: "Quản lý Hội viên & Giao dịch", icon: Users },
  { id: "stocks_casino", label: "Chứng khoán & Casino", icon: TrendingUp },
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-heading">
      ...
      <div className="max-w-4xl mx-auto px-4 py-4 overflow-hidden">
        ...
        <AnimatedTabPanel active={tab === "stocks_casino" || tab === "stocks" || tab === "casino"}>
          <AdminErrorBoundary>
            <StocksCasinoTab
              initialSubTab={tab === "casino" ? "casino" : "stocks"}
