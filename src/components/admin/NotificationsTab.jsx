...
export default function NotificationsTab() {
  ...
  const handleSendNotification = async () => {
    ...
    try {
      ...
      // NotificationBell.jsx (chuông chung của người dùng) hiển thị các
      // dòng Notification có user_id NULL (broadcast toàn hệ thống) hoặc
      // đúng chuỗi "admin" (broadcast tới quản trị viên).
      if (targetType === "all") {
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {filteredHistory.map((n) => {
            ...
            const typeConfig = ALL_KNOWN_TYPES.find((t) => t.id === n.type) || ALL_KNOWN_TYPES[0];
          ...
          >
            ...
            >
              ...
              <div className="p-5 overflow-y-auto space-y-4 flex-1">
                ...
                {/* 2b. Thông báo Đầu tư & Dự án notice */}
                <div className="p-2.5 rounded-xl bg-blue-50/60 border border-blue-100 text-[11px] text-blue-900 flex items-start gap-2">
                  <Briefcase className="w-4 h-4 text-blue-600 shrink-0 mt-0.5" />
                  <div className="leading-relaxed">
                    <span className="font-bold text-blue-800">Thông báo Đầu tư &amp; Dự án:</span> Hiện được quản lý trực tiếp tại từng thẻ dự án ở mục <b>Dự án</b> (nhấp nút <b>Thông báo</b> hoặc <b>Chỉnh sửa</b> tại dự án tương ứng) để quản trị viên có thể gửi thông báo đích danh đến người dùng đang đầu tư dự án đó hoặc broadcast toàn hệ thống.
                  </div>
                </div>
